...
% Parse the dataset into working variables (PERIOD 1953-2015):
%% Coral Growth Means
...
envar       = env.data(1:62,3:5);   % ENV Variables (m3/s,°C,SOI,AMO)
...
Variable      b             t-stat        p
---------------------------------------------------------------------
    intercept -0.00000      -0.00000      0.92600       
            1 0.01434       1.43010       0.16200       
            2 0.01926       2.06467       0.04300       
            3 -0.02621      -2.76773      0.00800       
---------------------------------------------------------------------
...
Variable      b             t-stat        p
---------------------------------------------------------------------
    intercept -0.00000      -0.00000      0.26800       
            1 -0.00790      -0.44578      0.66200       
            2 0.00660       0.40049       0.68500       
            3 0.05861       3.50184       0.00100       
---------------------------------------------------------------------
...
Variable      b             t-stat        p
---------------------------------------------------------------------
    intercept 0.00000       0.00000       0.31800       
            1 0.00629       0.43925       0.64900       
            2 0.02575       1.93173       0.05400       
            3 0.00807       0.59646       0.55200       
---------------------------------------------------------------------
